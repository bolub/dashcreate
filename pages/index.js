...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Info */}
      <div className="w-full md:w-2/5 my-auto mt-16 px-2 mx-auto">
        <div className="rounded-md bg-purple-100 text-purple-500 py-10 md:py-16 px-5 flex flex-col">
          <div className="md:m-auto">
            ...
            <div className="flex flex-row md:flex-row mb-6">
              ...
              <span className="font-bold ml-auto my-auto">To be Announced</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className="mt-8 m-auto" style={{ maxWidth: "850px" }}>
            ...
            <div className="mt-16">
              ...
              >
                ...
                <div className="flex flex-col justify-center md:flex-row mt-4 mb-8">
                  <button
